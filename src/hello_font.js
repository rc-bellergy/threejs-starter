...
function main () {
  ...
  // Example: create Text
  const geometry = new THREE.TextBufferGeometry('Hello Text', {
  ...
  console.log(geometry.boundingBox.getCenter(text.position))
  console.log(geometry.boundingBox.getCenter(text.position).multiplyScalar(-1))
